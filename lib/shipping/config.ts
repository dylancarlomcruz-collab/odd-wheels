...
export type ShipClass = "MINI_GT" | "KAIDO" | "POPRACE" | "ACRYLIC_TRUE_SCALE";
...
export const JNT_CAPACITY: Record<JntPouch, Record<ShipClass, number>> = {
  SMALL: { MINI_GT: 2, KAIDO: 2, POPRACE: 2, ACRYLIC_TRUE_SCALE: 1 },
  MEDIUM: { MINI_GT: 8, KAIDO: 8, POPRACE: 8, ACRYLIC_TRUE_SCALE: 4 }, // x4 of small
};

export const LBC_CAPACITY: Record<LbcPackage, Record<ShipClass, number>> = {
  N_SAKTO: { MINI_GT: 2, KAIDO: 1, POPRACE: 1, ACRYLIC_TRUE_SCALE: 1 },
  MINIBOX: { MINI_GT: 9, KAIDO: 4, POPRACE: 4, ACRYLIC_TRUE_SCALE: 4 },
  SMALL_BOX: {
