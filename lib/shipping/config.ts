import { GENERATED_REGION_BRANCH_CITY_OPTIONS } from "@/lib/shipping/branchCities";
...
export const REGION_BRANCH_CITY_OPTIONS: Record<Region, string[]> =
  GENERATED_REGION_BRANCH_CITY_OPTIONS;
