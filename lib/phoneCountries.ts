...
export const PHONE_COUNTRIES: PhoneCountry[] = [
  ...
  { iso2: "CA", name: "Canada", dialCode: "+1", aliases: ["ca"] },
  ...
  { iso2: "CD", name: "Democratic Republic of the Congo", dialCode: "+243", aliases: ["dr congo", "congo kinshasa"] },
  { iso2: "CR", name: "Costa Rica", dialCode: "+506" },
  { iso2: "CI", name: "Cote d'Ivoire", dialCode: "+225", aliases: ["ivory coast"] },
  { iso2: "HR", name: "Croatia", dialCode: "+385" },
  { iso2: "CY", name: "Cyprus", dialCode: "+357" },
  { iso2: "CZ", name: "Czech Republic", dialCode: "+420", aliases: ["czechia"] },
  ...
  { iso2: "SZ", name: "Eswatini", dialCode: "+268", aliases: ["swaziland"] },
  ...
  { iso2: "LA", name: "Laos", dialCode: "+856", aliases: ["lao", "lao pdr"] },
  ...
  { iso2: "MO", name: "Macau", dialCode: "+853", aliases: ["macao"] },
  ...
  { iso2: "MM", name: "Myanmar", dialCode: "+95", aliases: ["burma"] },
  { iso2: "NA", name: "Namibia", dialCode: "+264" },
  { iso2: "NP", name: "Nepal", dialCode: "+977" },
  { iso2: "NL", name: "Netherlands", dialCode: "+31", aliases: ["holland"] },
  ...
  { iso2: "MK", name: "North Macedonia", dialCode: "+389", aliases: ["macedonia"] },
  ...
  { iso2: "PH", name: "Philippines", dialCode: "+63", aliases: ["ph", "pilipinas"] },
  ...
  { iso2: "RU", name: "Russia", dialCode: "+7", aliases: ["russian federation"] },
  ...
  { iso2: "KR", name: "South Korea", dialCode: "+82", aliases: ["korea", "republic of korea"] },
  ...
  { iso2: "TL", name: "Timor-Leste", dialCode: "+670", aliases: ["east timor"] },
  ...
  { iso2: "GB", name: "United Kingdom", dialCode: "+44", aliases: ["uk", "britain", "great britain", "england"] },
  { iso2: "US", name: "United States", dialCode: "+1", aliases: ["usa", "us", "america"] },
  { iso2: "UY", name: "Uruguay", dialCode: "+598" },
  { iso2: "UZ", name: "Uzbekistan", dialCode: "+998" },
  { iso2: "VU", name: "Vanuatu", dialCode: "+678" },
  { iso2: "VA", name: "Vatican City", dialCode: "+379", aliases: ["holy see"] },
  { iso2: "VE", name: "Venezuela", dialCode: "+58" },
  { iso2: "VN", name: "Vietnam", dialCode: "+84", aliases: ["viet nam"] },
  { iso2: "VG", name: "Virgin Islands, British", dialCode: "+1" },
  { iso2: "VI", name: "Virgin Islands, U.S.", dialCode: "+1" },
  { iso2: "YE", name: "Yemen", dialCode: "+967" },
  { iso2: "ZM", name: "Zambia", dialCode: "+260" },
  { iso2: "ZW", name: "Zimbabwe", dialCode: "+263" },
];

const PHONE_COUNTRY_BY_ISO = new Map(
...
export function getPhoneCountryByIso(iso2: string): PhoneCountry | undefined {
  return PHONE_COUNTRY_BY_ISO.get(iso2.toUpperCase());
}

export function getPhoneCountryFlag(iso2: string): string {
  return iso2
    .toUpperCase()
    .replace(/./g, (char) =>
...
export function matchesPhoneCountryQuery(
...
export function findPhoneCountryFromInternationalPhone(
  value: string,
  ...
  for (const country of PHONE_COUNTRIES_BY_DIAL_CODE) {
    ...
    if (preferredIso2) {
      const preferred = getPhoneCountryByIso(preferredIso2);
      if (
        preferred &&
        preferred.dialCode.replace(/\D/g, "") === dialDigits
      ) {
        return preferred;
      }
    }
