...
export function useAllOrders() {
  ...
  const load = React.useCallback(async () => {
    ...
    try {
      ...
      // Keep orders usable even if the item join fails because of schema drift.
      const itemSelect =
        "id,order_id,product_id,variant_id,item_id,item_name,product_title,image_url,price_each,unit_price,cost_each,qty,line_total,condition,issue_notes,product_variant:product_variants(id,barcode,condition,issue_notes,public_notes,price,qty,product:products(id,title,brand,model,variation,image_urls))";
